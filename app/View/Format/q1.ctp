...
<?php $options_new = array(
 		'Type1' => __('<span class="showDialog" data-id="dialog_1" style="color:blue" title="">Type1</span><div id="dialog_1" class="hide" title="Type 1">
 				<span style="display:inline-block"><ul><li>Description .......</li>
 				<li>Description 2</li></ul></span>
 				</div>'),
		'Type2' => __('<span class="showDialog" data-id="dialog_2" style="color:blue" title="">Type2</span><div id="dialog_2" class="hide" title="Type 2">
...
<?php echo $this->Form->submit('Save', array('class' => 'btn btn-success', 'id' => 'savebtn', 'disabled' => 'disabled'));?>
...
$(document).ready(function(){
    ...
    $(".showDialog").tooltip({
            content: function() {
                return $($('#' + $(this).data('id'))[0].outerHTML).removeClass('hide')[0].outerHTML;
            },
            position: {my: 'right-10 center'},
        });
